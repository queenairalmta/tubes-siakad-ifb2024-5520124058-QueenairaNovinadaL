            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @else
                        ...
                        <x-nav-link :href="route('mahasiswa.jadwal')" :active="request()->routeIs('mahasiswa.jadwal')">
                            {{ __('Jadwal') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @else
                ...
                <x-responsive-nav-link :href="route('mahasiswa.jadwal')" :active="request()->routeIs('mahasiswa.jadwal')">
                    {{ __('Jadwal') }}
                </x-responsive-nav-link>
